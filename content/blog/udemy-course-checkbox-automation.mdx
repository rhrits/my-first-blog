---
title: "Udemy Course Checkbox Automation Script"
description: Automate expanding Udemy course sections and checking lesson completion with this simple JavaScript script.
date: 2024-10-16
published: true
---
...
This blog post provides a JavaScript automation script designed to simplify the process of expanding all course sections and checking lesson completion checkboxes on Udemy. By running this script directly in the browser's developer console, users can easily mark their progress across multiple lessons and expand all course content with a single command. The post includes step-by-step instructions for using the script, making it an essential tool for Udemy course takers looking to streamline their learning experience.
...
1. Fork the [ repository ](https://github.com/rhrits/Udemy-Course-Checkbox-Automation).
2. Make your changes.
